<div
    class="mb-4 rounded-xl border border-gray-200 bg-white shadow-sm"
    x-data="{
        farmaciaId: {{ $farmacia->id_farmacia }},
        farmaciaNombre: @js($farmacia->nombre)
    }"
>
    <div class="p-4">
        ...
        <ul class="space-y-1">
            ...
            @php
                ...
                $cantidadReportes = Reporte::where(
                    'id_farmacia',
