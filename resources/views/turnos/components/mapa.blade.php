<div class="lg:sticky lg:top-24">
    ...
    <div id="mapa-contenedor" class="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm h-[350px] lg:h-[calc(100vh-8rem)] relative">
        ...
        <button
            ...
            class="lg:hidden absolute bottom-4 right-4 z-[1000] w-10 h-10 inline-flex items-center justify-center
                   bg-white border border-gray-200 rounded-xl text-slate-600 shadow-md
